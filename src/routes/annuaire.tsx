            ...
            {list.map((provider) => (
              ...
              >
                ...
                <a
                  ...
                  className="mt-4 block rounded-lg text-left outline-none transition-colors hover:text-muted-foreground focus-visible:ring-2 focus-visible:ring-foreground"
